...
EPICatac is based on reference ATAC-Seq profiles for the main non-malignant
...
This framework relies on the implementation of EPIC previously developed for bulk RNA-Seq data deconvolution and described in the publication from *Racle et al., 2017* available
...
If you plan to use EPICatac (version 1.1) in any for-profit application, you are
...
* EPICatac predicts the proportions of the various cell types for which we have
...
present for which we don't have any reference profile. EPICatac returns the
