...
at <https://elifesciences.org/articles/26476>. We recommend loading the EPIC package for RNA-Seq deconvolution and EPICATAC for ATAC-Seq deconvolution to
avoid conflicts between EPIC and EPICATAC functions, in particular EPIC should not be loaded before EPICATAC in order to use EPICATAC functions. 
